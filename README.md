...
## Лекция 1.3 [Классификация БД и СУБД. Состав и функции СУБД. Трехуровневая архитектура БД и СУБД]([https://clck.ru/3DMfHC](https://docs.google.com/presentation/d/1LNbZEjbR_6uI4JKtC2inaO2LrCMfb3HD/edit#slide=id.p1)) (презентация и текстовые материалы)
## Сдача работ

...
-- Started on 2025-04-14 10:53:12 UTC
...
--
-- TOC entry 6 (class 2615 OID 16870)
...
--
-- TOC entry 3261 (class 2604 OID 16919)
...
--
-- TOC entry 3262 (class 2604 OID 16920)
...
--
-- TOC entry 3263 (class 2604 OID 16921)
...
--
-- TOC entry 3267 (class 2604 OID 16925)
...
--
-- TOC entry 3268 (class 2604 OID 16926)
...
--
-- TOC entry 3269 (class 2604 OID 16927)
...
--
-- TOC entry 3270 (class 2604 OID 16928)
...
--
-- TOC entry 3271 (class 2604 OID 16929)
...
--
-- TOC entry 3483 (class 0 OID 16871)
-- Dependencies: 218
...
--
-- TOC entry 3485 (class 0 OID 16877)
-- Dependencies: 220
...
--
-- TOC entry 3487 (class 0 OID 16881)
-- Dependencies: 222
...
--
-- TOC entry 3489 (class 0 OID 16885)
-- Dependencies: 224
-- Data for Name: driver; Type: TABLE DATA; Schema: lab3; Owner: postgres
--

COPY lab3.driver (full_name, address, telephone_number, driver_id) FROM stdin;
Иванов Иван Иванович	г. Москва, ул. Ленина, д. 10, кв. 25	89161234567	1
Петров Петр Петрович	г. Санкт-Петербург, Невский пр-т, д. 15	89219876543	2
Сидорова Анна Михайловна	г. Казань, ул. Баумана, д. 5	89376543210	3
Кузнецов Алексей Владимирович	г. Екатеринбург, ул. Малышева, д. 33	89091234567	4
Смирнова Ольга Дмитриевна	г. Новосибирск, Красный пр-т, д. 28	89518765432	5
Федоров Дмитрий Сергеевич	г. Нижний Новгород, ул. Рождественская, д. 12	89107654321	6
Николаева Екатерина Андреевна	г. Самара, ул. Куйбышева, д. 45	89261234567	7
Орлов Михаил Викторович	г. Омск, ул. Ленина, д. 1	89876543210	8
Морозов Артем Игоревич	г. Ростов-на-Дону, ул. Большая Садовая, д. 10	89011234567	9
Волкова Татьяна Николаевна	г. Уфа, ул. Ленина, д. 42	89198765432	10
Лебедев Сергей Александрович	г. Краснодар, ул. Красная, д. 100	89261234567	11
Соколова Марина Викторовна	г. Челябинск, пр-т Ленина, д. 50	89876543210	12
Павлов Игорь Олегович	г. Воронеж, ул. Плехановская, д. 5	89031234567	13
Козлов Андрей Петрович	г. Пермь, ул. Ленина, д. 60	89128765432	14
Новикова Елена Владимировна	г. Волгоград, пр-т Ленина, д. 25	89211234567	15
\.


--
-- TOC entry 3491 (class 0 OID 16889)
-- Dependencies: 226
...
--
-- TOC entry 3493 (class 0 OID 16895)
-- Dependencies: 228
-- Data for Name: insurances; Type: TABLE DATA; Schema: lab3; Owner: postgres
--

COPY lab3.insurances (start_date, end_date, coverage_amount, insurance_type, insurance_company, insurance_status, insurance_number, car_id) FROM stdin;
2023-01-15	2024-01-14	500000	ОСАГО	Росгосстрах	активна	1	3
2022-11-20	2023-11-19	500000	ОСАГО	Ингосстрах	неактивна	2	7
2023-03-10	2024-03-09	500000	ОСАГО	СОГАЗ	активна	3	1
2021-05-05	2022-05-04	400000	ОСАГО	РЕСО-Гарантия	неактивна	4	9
2023-02-28	2024-02-27	500000	ОСАГО	АльфаСтрахование	активна	5	2
2023-01-01	2024-01-01	1500000	КАСКО	ВТБ Страхование	активна	6	4
2022-07-15	2023-07-14	2000000	КАСКО	СберСтрахование	неактивна	7	6
2023-04-20	2024-04-19	1800000	КАСКО	Ренессанс Страхование	активна	8	8
2022-12-10	2023-12-09	1200000	КАСКО	Тинькофф Страхование	неактивна	9	5
2023-05-15	2024-05-14	1700000	КАСКО	Зетта Страхование	активна	10	10
2023-06-01	2024-05-31	500000	ОСАГО	Росгосстрах	активна	11	2
2022-09-10	2023-09-09	2000000	КАСКО	АльфаСтрахование	неактивна	12	3
2023-03-15	2024-03-14	500000	ОСАГО	СОГАЗ	активна	13	7
2022-12-01	2023-11-30	1600000	КАСКО	ВТБ Страхование	неактивна	14	4
2023-07-01	2024-06-30	500000	ОСАГО	РЕСО-Гарантия	активна	15	1
\.
...
COPY lab3.officers (full_name, officer_personal_number, badge_number, telephone_number) FROM stdin;
Иванов А.А.	1	\N	\N
Петров Б.В.	2	\N	\N
Сидоров Г.Д.	3	\N	\N
Кузнецова Е.Ж.	4	\N	\N
...
--
-- TOC entry 3497 (class 0 OID 16903)
-- Dependencies: 232
-- Data for Name: participant; Type: TABLE DATA; Schema: lab3; Owner: postgres
--

COPY lab3.participant (role_id, driver_id, accident_code, fault, participant_id, car_id) FROM stdin;
3	5	7	\N	13	\N
4	7	2	\N	14	\N
5	1	4	\N	15	\N
1	3	5	виновен	1	3
...
--
-- TOC entry 3499 (class 0 OID 16907)
-- Dependencies: 234
...
--
-- TOC entry 3501 (class 0 OID 16911)
-- Dependencies: 236
...
COPY lab3.violations (traffic_code_id, fine_amount, payment_amount, payment_date, violation_status, violation_date_time, violation_address, disqualification_start_date, disqualification_end_date, payment_percentage, violation_id, participant_id) FROM stdin;
7	5000	5000	2023-05-10	оплачено	2023-05-01 14:25:00	ул. Ленина, 10	\N	\N	1	1	2
3	3000	3000	2023-05-12	оплачено	2023-05-05 09:15:00	пр. Победы, 15	\N	\N	1	2	5
15	2000	2000	2023-05-15	оплачено	2023-05-10 18:30:00	ул. Гагарина, 5	\N	\N	1	3	8
12	4000	1000	2023-05-18	не оплачено	2023-05-12 12:45:00	ул. Кирова, 20	2023-05-18	2023-06-18	0.25	4	11
5	5000	2500	2023-05-20	не оплачено	2023-05-15 16:20:00	ул. Советская, 8	2023-05-20	2023-07-20	0.5	5	14
18	6000	4500	2023-05-22	не оплачено	2023-05-18 21:10:00	ул. Мира, 12	2023-05-22	2023-08-22	0.75	6	3
9	3500	0	\N	не оплачено	2023-05-25 11:30:00	ул. Пушкина, 3	2023-05-25	2023-08-25	0	7	6
2	2500	0	\N	не оплачено	2023-05-28 08:40:00	ул. Садовая, 7	2023-05-28	2023-07-28	0	8	9
14	4500	0	\N	не оплачено	2023-05-30 19:15:00	ул. Центральная, 25	2023-05-30	2023-11-30	0	9	12
8	5500	0	\N	не оплачено	2023-06-01 22:50:00	ул. Лесная, 18	2023-06-01	2024-06-01	0	10	15
\.
...
--
-- TOC entry 3305 (class 2606 OID 16931)
...
--
-- TOC entry 3280 (class 2606 OID 16932)
...
--
-- TOC entry 3283 (class 2606 OID 16933)
...
--
-- TOC entry 3277 (class 2606 OID 16934)
...
--
-- TOC entry 3307 (class 2606 OID 16936)
...
--
-- TOC entry 3309 (class 2606 OID 16938)
...
--
-- TOC entry 3272 (class 2606 OID 16939)
...
--
-- TOC entry 3274 (class 2606 OID 16941)
...
--
-- TOC entry 3275 (class 2606 OID 16942)
...
--
-- TOC entry 3276 (class 2606 OID 16943)
...
--
-- TOC entry 3287 (class 2606 OID 16944)
...
--
-- TOC entry 3296 (class 2606 OID 16945)
...
--
-- TOC entry 3313 (class 2606 OID 16948)
...
--
-- TOC entry 3311 (class 2606 OID 16950)
...
--
-- TOC entry 3288 (class 2606 OID 16951)
...
--
-- TOC entry 3294 (class 2606 OID 16952)
-- Name: participant fault_check; Type: CHECK CONSTRAINT; Schema: lab3; Owner: postgres
--

ALTER TABLE lab3.participant
    ADD CONSTRAINT fault_check CHECK ((((fault)::text = ANY (ARRAY[('виновен'::character varying)::text, ('невиновен'::character varying)::text])) OR (fault IS NULL))) NOT VALID;


--
-- TOC entry 3297 (class 2606 OID 16953)
...
--
-- TOC entry 3293 (class 2606 OID 16954)
...
--
-- TOC entry 3281 (class 2606 OID 16955)
...
--
-- TOC entry 3289 (class 2606 OID 16956)
...
--
-- TOC entry 3290 (class 2606 OID 16957)
-- Name: insurances insurance_status_check; Type: CHECK CONSTRAINT; Schema: lab3; Owner: postgres
--

ALTER TABLE lab3.insurances
    ADD CONSTRAINT insurance_status_check CHECK (((insurance_status)::text = ANY (ARRAY[('активна'::character varying)::text, ('неактивна'::character varying)::text]))) NOT VALID;


--
-- TOC entry 3291 (class 2606 OID 16958)
-- Name: insurances insurance_type_check; Type: CHECK CONSTRAINT; Schema: lab3; Owner: postgres
--

ALTER TABLE lab3.insurances
    ADD CONSTRAINT insurance_type_check CHECK (((insurance_type)::text = ANY (ARRAY[('ОСАГО'::character varying)::text, ('КАСКО'::character varying)::text]))) NOT VALID;
...
--
-- TOC entry 3285 (class 2606 OID 16961)
...
--
-- TOC entry 3286 (class 2606 OID 16962)
...
--
-- TOC entry 3317 (class 2606 OID 16964)
...
--
-- TOC entry 3319 (class 2606 OID 16966)
...
--
-- TOC entry 3298 (class 2606 OID 16967)
...
--
-- TOC entry 3299 (class 2606 OID 16968)
...
--
-- TOC entry 3300 (class 2606 OID 16969)
...
--
-- TOC entry 3278 (class 2606 OID 16970)
...
--
-- TOC entry 3321 (class 2606 OID 16972)
...
--
-- TOC entry 3292 (class 2606 OID 16973)
...
--
-- TOC entry 3282 (class 2606 OID 16974)
...
--
-- TOC entry 3323 (class 2606 OID 16976)
...
--
-- TOC entry 3295 (class 2606 OID 16977)
...
--
-- TOC entry 3301 (class 2606 OID 16978)
...
--
-- TOC entry 3302 (class 2606 OID 16979)
...
--
-- TOC entry 3303 (class 2606 OID 16980)
-- Name: violations violation_status_check; Type: CHECK CONSTRAINT; Schema: lab3; Owner: postgres
--

ALTER TABLE lab3.violations
    ADD CONSTRAINT violation_status_check CHECK (((violation_status)::text = ANY (ARRAY[('оплачено'::character varying)::text, ('не оплачено'::character varying)::text]))) NOT VALID;


--
-- TOC entry 3325 (class 2606 OID 16982)
...
--
-- TOC entry 3279 (class 2606 OID 16983)
...
--
-- TOC entry 3332 (class 2606 OID 16984)
...
--
-- TOC entry 3331 (class 2606 OID 17039)
-- Name: insurances car_id fkey; Type: FK CONSTRAINT; Schema: lab3; Owner: postgres
--

ALTER TABLE ONLY lab3.insurances
    ADD CONSTRAINT "car_id fkey" FOREIGN KEY (car_id) REFERENCES lab3.cars(car_id) NOT VALID;


--
-- TOC entry 3328 (class 2606 OID 16989)
...
--
-- TOC entry 3333 (class 2606 OID 17044)
-- Name: participant car_id_fkey; Type: FK CONSTRAINT; Schema: lab3; Owner: postgres
--
...
--
-- TOC entry 3329 (class 2606 OID 16994)
...
--
-- TOC entry 3330 (class 2606 OID 16999)
...
--
-- TOC entry 3334 (class 2606 OID 17004)
...
--
-- TOC entry 3326 (class 2606 OID 17019)
...
--
-- TOC entry 3336 (class 2606 OID 17049)
-- Name: violations participant_id_fkey; Type: FK CONSTRAINT; Schema: lab3; Owner: postgres
--

ALTER TABLE ONLY lab3.violations
    ADD CONSTRAINT participant_id_fkey FOREIGN KEY (participant_id) REFERENCES lab3.participant(participant_id) NOT VALID;
...
--
-- TOC entry 3337 (class 2606 OID 17029)
...
--
-- TOC entry 3327 (class 2606 OID 17034)
...
-- Completed on 2025-04-14 10:53:12 UTC
